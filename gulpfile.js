...
gulp.task('styles', function() {
    ...
    return gulp.src(assets + '/css/sass/styles.scss')
...
gulp.task('scripts', function() {
    return gulp.src(assets + '/js/td/*.js')
...
gulp.task('watch', function() {
    ...
    gulp.watch([assets + '/css/sass/**/*.scss', assets + '/css/sass/**/*.sass' ], ['styles'])
        .on('change', function(event) {
                console.log('File ' + event.path + ' was ' + event.type + ', running CSS task...');
            }
        );

    gulp.watch(assets + '/js/td/*.js', ['scripts'])
        .on('change', function(event) {
